...
export type AuditChainJobVerification = {
   ...
   */
  dispatchAttempts: Scalars["Int"]["output"];
  /**
   ...
   */
  duplicateDeliveries: Scalars["Int"]["output"];
  /** `module_executions.id` — the ledger's `execution_id` and the S3 prefix. */
  moduleExecutionId: Scalars["String"]["output"];
...
export type MlModelSummary = {
   ...
   * is.
   */
  promotedAccuracyCi95?: Maybe<Array<Scalars["Float"]["output"]>>;
  /**
   ...
   */
  promotedAccuracyMeasuredAt?: Maybe<Scalars["String"]["output"]>;
  /**
   ...
   */
  promotedAccuracyN?: Maybe<Scalars["Int"]["output"]>;
  /** The promoted version's backend (`knn-pgvector`, `linear-logreg`, …). */
  promotedBackend?: Maybe<Scalars["String"]["output"]>;
...
export type MlResolveResult = {
   ...
   */
  siblingsResolved: Scalars["Int"]["output"];
