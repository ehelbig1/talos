      ...
      <div className="relative z-10 text-center space-y-8 animate-in fade-in zoom-in-95 duration-1000">
        <div className="relative inline-block group">
          ...
          <div className="relative w-24 h-24 rounded-3xl bg-surface-1/60 border border-white/10 flex items-center justify-center shadow-2xl glass-dark optimize-blur">
            <Zap size={48} className="text-primary animate-status-pulse" fill="currentColor" />
          </div>
        </div>
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col h-screen bg-background font-inter">
        ...
        {/* Navigation */}
        <nav role="navigation" aria-label="Main navigation" className="h-16 flex items-center px-8 gap-10 shrink-0 z-50 border-b border-white/5 bg-surface-1/40 backdrop-blur-3xl relative">
          ...
          <div className="flex items-center gap-2 relative z-10">
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">View and manage saved workflows</TooltipContent></Tooltip>
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">Build workflows on the visual canvas</TooltipContent></Tooltip>
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">Manage AI execution identities</TooltipContent></Tooltip>
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">Browse templates and installed modules</TooltipContent></Tooltip>
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">Integrations, security, and account</TooltipContent></Tooltip>
          </div>
          ...
          <div className="ml-auto flex items-center gap-6 relative z-10">
            ...
            </TooltipTrigger><TooltipContent side="bottom" className="bg-surface-4 border-white/5 text-[10px] font-black uppercase tracking-widest shadow-2xl">System health</TooltipContent></Tooltip>
            
            <div className="h-6 w-px bg-white/5 mx-1" />
            
            <div className="flex flex-col items-end">
              <span className="font-black text-white text-xs tracking-tight font-outfit leading-none">{user?.name || 'User'}</span>
              <span className="text-[10px] text-muted-foreground/30 font-bold uppercase tracking-tight mt-1">{user?.email}</span>
            </div>
        ...
        {/* Page content */}
        <main id="main-content" role="main" className="flex-1 overflow-hidden bg-background">
          <ErrorBoundary>
            <Suspense fallback={<LoadingScreen />}>
              <Routes>
                ...
                <Route path="/catalog" element={<Navigate to="/library#templates" replace />} />
                <Route path="/modules" element={<Navigate to="/library#installed" replace />} />
