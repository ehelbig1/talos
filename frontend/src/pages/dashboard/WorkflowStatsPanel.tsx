      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground/40 font-black tracking-[0.3em] uppercase">
              Last 168 Hours
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 relative z-10">
        <div className="bg-surface-2/40 border border-white/5 rounded-[2rem] p-6 group hover:border-primary/30 transition-premium hover:scale-[1.02] active:scale-95 shadow-xl glass-light">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-widest group-hover:text-white/60 transition-colors">
              Throughput
            </span>
          </div>
        ...
        <div className="bg-surface-2/40 border border-white/5 rounded-[2rem] p-6 group hover:border-destructive/30 transition-premium hover:scale-[1.02] active:scale-95 shadow-xl glass-light">
          ...
          <p className="text-3xl font-black text-white group-hover:text-destructive transition-premium font-outfit tracking-tight">
