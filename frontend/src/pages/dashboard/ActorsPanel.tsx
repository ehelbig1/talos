...
export default function ActorsPanel() {
  ...
  const totalExecs = actors.reduce(
    (s, a) => s + (a.executionCount ?? 0),
    0,
  );
    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-sm font-black text-white tracking-tighter uppercase font-outfit">Registry</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-surface-4/40 border border-white/5 rounded-[1.5rem] p-4 group hover:border-success/30 transition-premium glass-light shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]">Active</span>
          </div>
          <p className="text-3xl font-black text-white font-outfit tracking-tighter transition-colors group-hover:text-success">{active}</p>
        </div>
        ...
        <div className="bg-surface-4/40 border border-white/5 rounded-[1.5rem] p-4 group hover:border-warning/30 transition-premium glass-light shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]">Paused</span>
          </div>
          <p className="text-3xl font-black text-white font-outfit tracking-tighter transition-colors group-hover:text-warning">{paused}</p>
        </div>
        ...
        <div className="bg-surface-4/40 border border-white/5 rounded-[1.5rem] p-4 group hover:border-destructive/30 transition-premium glass-light shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]">Failure</span>
          </div>
          <p className="text-3xl font-black text-white font-outfit tracking-tighter transition-colors group-hover:text-destructive">{error}</p>
        </div>
        ...
        <div className="bg-surface-4/40 border border-white/5 rounded-[1.5rem] p-4 group hover:border-primary/30 transition-premium glass-light shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]">Loads</span>
          </div>
          <p className="text-2xl font-black text-white font-outfit tracking-tighter leading-none mt-1">
            {totalExecs >= 1000 ? `${(totalExecs / 1000).toFixed(1)}k` : totalExecs}
          </p>
        </div>
      </div>
    </div>
