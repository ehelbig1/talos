    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="text-center py-24 bg-surface-3/40 border border-white/10 border-dashed rounded-[4rem] shadow-2xl backdrop-blur-3xl glass gpu relative overflow-hidden">
        ...
        <p className="text-sm text-muted-foreground/40 font-bold uppercase tracking-widest mb-10 max-w-lg mx-auto leading-relaxed">
          Automate complex operations by orchestrating modules into high-fidelity visual pipelines. 
          Start from a clean slate or utilize registered protocols.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center border mb-6 shadow-2xl transition-premium group-hover:scale-110", card.color)}>
              ...
              <p className="text-[11px] text-muted-foreground/40 font-bold leading-relaxed uppercase tracking-widest">{card.desc}</p>
            </button>
          ))}
        </div>
      </div>
