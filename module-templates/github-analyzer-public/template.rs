...
fn run(input: String) -> Result<String, String> {
    ...
    logging::log(Level::Info, "1. Starting GitHub Repo Analyzer (Public) module");
    ...
    logging::log(Level::Info, "4. Using simple substring match instead of Regex");
    ...
    logging::log(Level::Info, "5. Sending HTTP request");
    ...
    logging::log(Level::Info, &format!("6. Got HTTP response. Body size: {}", response.body.len()));
    ...
    logging::log(Level::Info, &format!("7. Parsed {} commits", commits.len()));
    ...
    logging::log(Level::Info, "8. Finished loop");
    ...
    logging::log(Level::Info, "9. Serialization done");
