...
PRs do not edit this file: `scripts/changelog-update.sh` generates the
`[Unreleased]` entries from merged PR titles. Crate-level changelogs that need
prose take fragment files instead (e.g. `talos-workflow-engine/changelog.d/`).
